<?php /*a:2:{s:58:"F:\wamp64\www\lingtu\application\admin\view\Role\role.html";i:1537848516;s:66:"F:\wamp64\www\lingtu\application\admin\view\Indexpublic\index.html";i:1538198545;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
            ...
            <form action = '' method="get">
                <div class="">
                    <select class="selectpicker form-control" name = 'search_type' style = 'width: 90px;padding:0px !important;cursor:pointer;float: left'>
                        ...
                        <option value = 'title'   <?php if(($s_ty == 'title')): ?> 	selected<?php endif; ?>> 角色名称 						</option>
                    </select>
        ...
        <table  class="display table table-bordered table-striped" id="dynamic-table">
            ...
            <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td  class = 'double_updata_txt' tableName='title' thisID="<?php echo htmlentities($row['id']); ?>" clickTable = '<?php echo htmlentities($table); ?>' clickRes = '/lingtu/public/<?php echo htmlentities($con); ?>/double_updata_txt'><?php echo htmlentities($row['title']); ?></td>
                    <td>
                ...
                <div class="dataTables_info" id="editable-sample_info">
                    <div class="dataTables_paginate paging_bootstrap pagination" id = 'page'>
                        ...
                        <ul>
                            ...
                            <?php $__FOR_START_24003__=$pros;$__FOR_END_24003__=$proe;for($i=$__FOR_START_24003__;$i < $__FOR_END_24003__;$i+=1){ ?>
...
　　//formdata储存异步上传数据
     ...
     $.ajax({
      url:'/lingtu/public/<?php echo htmlentities($con); ?>/<?php echo htmlentities($fun); ?>DoAdd',
      type: 'POST',
      data: formData,
      //这两个设置项必填
      contentType: false,
