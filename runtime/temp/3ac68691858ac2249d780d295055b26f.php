<?php /*a:2:{s:60:"F:\wamp64\www\lingtu\application\admin\view\Admin\admin.html";i:1537504844;s:66:"F:\wamp64\www\lingtu\application\admin\view\Indexpublic\index.html";i:1538198545;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
            ...
            <form action = '' method="get">
                <div class="">
                    <select class="selectpicker form-control" name = 'search_type' style = 'width: 90px;padding:0px !important;cursor:pointer;float: left'>
                        ...
                        <option value = 'admin_user'   <?php if(($s_ty == 'admin_user')): ?> 	selected<?php endif; ?>> 管理员账号 						</option>
                        <option value = 'admin_name'   <?php if(($s_ty == 'admin_name')): ?> 		selected<?php endif; ?>> 管理员昵称  					</option>
                        <option value = 'status'       <?php if(($s_ty == 'status')): ?> 	selected<?php endif; ?>> 状态(1为正常,2为暂停)  </option>
                        <option value = 'level'        <?php if(($s_ty == 'level')): ?>   selected<?php endif; ?>> 权限等级(1为一级,2为二级)	</option>
                    </select>
        ...
        <table  class="display table table-bordered table-striped" id="dynamic-table">
            ...
            <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td><img  style = 'width:35px;'src = "<?php echo htmlentities($row['img']); ?>"></td> 
                    <td><?php echo htmlentities($row['admin_name']); ?></td>
                    <td><?php echo htmlentities($row['admin_user']); ?></td>
                ...
                <div class="dataTables_info" id="editable-sample_info">
                    <div class="dataTables_paginate paging_bootstrap pagination" id = 'page'>
                        ...
                        <ul>
                            ...
                            <?php $__FOR_START_16684__=$pros;$__FOR_END_16684__=$proe;for($i=$__FOR_START_16684__;$i < $__FOR_END_16684__;$i+=1){ ?>
